...
public class LootTable extends WeightedList<Supplier<ItemStack>> {
	...
	public static void init(Main plugin) {
		...
		STRONGHOLD_LOOT_TABLE.add(new SimpleLootTableEntry(new ItemStack(Material.AMETHYST_SHARD, 3)), 5);
		STRONGHOLD_LOOT_TABLE.add(new SimpleLootTableEntry(new ItemStack(Material.LEATHER, 5)), 20);
		ItemStack leatherIronGrade = ItemGradeUtils.createGradedItem(new ItemStack(Material.LEATHER, 3), ItemGrade.IRON);
		...
		STRONGHOLD_LOOT_TABLE.add(new SimpleLootTableEntry(new ItemStack(Material.APPLE, 5)), 20);
		ItemStack appleIronGrade = ItemGradeUtils.createGradedItem(new ItemStack(Material.APPLE, 3), ItemGrade.IRON);
		...
		SWAMP_LOOT_TABLE.add(new SimpleLootTableEntry(new ItemStack(Material.DARK_OAK_SAPLING, 2)), 3);
		...
		NETHER_LOOT_TABLE.add(new SimpleLootTableEntry(new ItemStack(Material.PALE_OAK_SAPLING, 2)), 5);
		...
		DEEP_DARK_LOOT_TABLE.add(new SimpleLootTableEntry(CustomItem.SWIFTNESS_II_EXTENDED.getItemStack()), 4);
		DEEP_DARK_LOOT_TABLE.add(new SimpleLootTableEntry(CustomItem.SWIFTNESS_III.getItemStack()), 4);
		DEEP_DARK_LOOT_TABLE.add(new SimpleLootTableEntry(CustomItem.SWIFTNESS_III_EXTENDED.getItemStack()), 4);
		...
		DEEP_DARK_LOOT_TABLE.add(new SimpleLootTableEntry(new ItemStack(Material.GOLDEN_CARROT, 10)), 10);
		DEEP_DARK_LOOT_TABLE.add(new SimpleLootTableEntry(new ItemStack(Material.INK_SAC, 5)), 10);
		ItemStack glowInkSacIronGrade = ItemGradeUtils.createGradedItem(new ItemStack(Material.INK_SAC, 3), ItemGrade.IRON);
		DEEP_DARK_LOOT_TABLE.add(new SimpleLootTableEntry(glowInkSacIronGrade), 3);
		DEEP_DARK_LOOT_TABLE.add(new SimpleLootTableEntry(new ItemStack(Material.GLOW_SQUID_SPAWN_EGG)), 2);
		...
		DEEP_DARK_LOOT_TABLE.add(new SimpleLootTableEntry(deepslateIronGrade), 5);
