...
public class MobSpawnPool extends WeightedList<CustomMob> {
    ...
    public static void init() {
        ...
        STRONGHOLD_NIGHT_MOBS.add(CustomMob.SWIFT_BOMBER, 10);
        ...
        DESERT_NIGHT_MOBS.add(CustomMob.TURBO_BOMBER, 8);
        ...
        SWAMP_DAY_MOBS.add(CustomMob.SWIFT_BOMBER, 8);
        ...
        SWAMP_NIGHT_MOBS.add(CustomMob.TURBO_BOMBER, 10);
        ...
        DEEP_DARK_DAY_MOBS.add(CustomMob.TURBO_BOMBER, 15);
        DEEP_DARK_DAY_MOBS.add(CustomMob.TURBO_BOMBER, 5);
        ...
        DEEP_DARK_NIGHT_MOBS.add(CustomMob.TURBO_BOMBER, 15);
