...
public class DeepDarkBossFight implements BossFight {
    ...
    public void start(MazeRegion region) {
        ...
        Location enemySpawnLocation1 = new Location(bossRoomOrigin.getWorld(), -4, 1, -22, yaw, 0);
        ...
        Location enemySpawnLocation2 = new Location(bossRoomOrigin.getWorld(), 4, 1, -22, yaw, 0);
