...
public class DeepDarkBossFight implements BossFight {
    ...
    public void start(MazeRegion region) {
        ...
        Location enemySpawnLocation1 = new Location(bossRoomCenter.getWorld(), -4, 1, -3, yaw, 0);
        ...
        Location enemySpawnLocation2 = new Location(bossRoomCenter.getWorld(), 4, 1, -3, yaw, 0);
