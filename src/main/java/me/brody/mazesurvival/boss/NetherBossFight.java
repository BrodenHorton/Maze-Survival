...
public class NetherBossFight implements BossFight {
    ...
    public void start(MazeRegion region) {
        ...
        Location enemySpawnLocation1 = new Location(bossRoomOrigin.getWorld(), -3, 8, -22, yaw, 0);
        ...
        Location enemySpawnLocation2 = new Location(bossRoomOrigin.getWorld(), 3, 8, -22, yaw, 0);
